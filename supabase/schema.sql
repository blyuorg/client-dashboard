...
-- ============================================================
-- OAUTH-INTEGRATED MEETING SCHEDULER
-- ============================================================
-- See migrations/202608230001_meeting_scheduler.sql for the annotated
-- version — deliberately separate from the `meetings` table above (an
-- unrelated, simpler admin-written project log).
